...
The table below describes main symbols on device body, that depict functions of
a multimeter:

\begin{tabular}{| m{6em} | m{22em} | m{6em} |}
  \hline
  \textbf{Designation} & \textbf{Description} & \textbf{Measurement unit} \\
  \hline
