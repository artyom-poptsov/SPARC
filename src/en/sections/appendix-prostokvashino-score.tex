...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\chapter{The musical score for "If only there will be no winter"}
...
\begin{figure}[ht]
  ...
  \end{lilypond}
  \caption{The melody ``If only there will be no winter'' from the cartoon
    ``Prostokvashino''. Author: Evgeniy Krylatov (Евгений Крылатов.)}
