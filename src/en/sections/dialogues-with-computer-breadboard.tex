...
\note{ Not that LEDs and some other components are usually connected to an
  Arduino platform through a resistor -- as was discussed in section
  \ref{section:electronics-resistance} a resistor allows to limit the current in
  a circuit thus protecting electronic components from premature failures. }
