...
\experiment{1}{Let's try to connect the positive contact of the LED (anode) to
  the ground (\texttt{GND}.  The LED should switch off.  Why?}

\experiment{1}{Now let's replace the resistor in our circuit with another one
  with greater resistance (say, 500Ohm.)  How and why the LED brightness
  changed?}
