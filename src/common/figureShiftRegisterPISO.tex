...
\newcommand{\figureShiftRegisterPISO}[1]{
  ...
  \ifx \lang\langRu
  \def\figureCaption{
    Распиновка последовательно-параллельного сдвигового регистра 74HC165.
  }
  \fi
  \ifx \lang\langEn
  \def\figureCaption{
    Pinout of parallel-in/serial-out shift register 74HC165.
  }
  \fi
  \begin{figure}[ht]
    \centering
    \begin{tikzpicture}
      ...
      \node[anchor=east] at (-0.25, 7.50) {$\overline{LD}$};
      \node[anchor=west] at (0, 6.75) {2};
      \node[anchor=east] at (-0.25, 6.75) {CLK};
      \node[anchor=west] at (0, 6.00) {3};
      \node[anchor=east] at (-0.25, 6.00) {D4};
      \node[anchor=west] at (0, 5.25) {4};
      \node[anchor=east] at (-0.25, 5.25) {D5};
      \node[anchor=west] at (0, 4.50) {5};
      \node[anchor=east] at (-0.25, 4.50) {D6};
      \node[anchor=west] at (0, 3.75) {6};
      \node[anchor=east] at (-0.25, 3.75) {D7};
      \node[anchor=west] at (0, 3.00) {7};
      \node[anchor=east] at (-0.25, 3.00) {$\overline{Q7}$};
      ...
      \node[anchor=west] at (3.25, 6.75) {CE};
      \node[anchor=east] at (3, 6.00) {14};
      \node[anchor=west] at (3.25, 6.00) {D3};
      \node[anchor=east] at (3, 5.25) {13};
      \node[anchor=west] at (3.25, 5.25) {D2};
      \node[anchor=east] at (3, 4.50) {12};
      \node[anchor=west] at (3.25, 4.50) {D1};
      \node[anchor=east] at (3, 3.75) {11};
      \node[anchor=west] at (3.25, 3.75) {D0};
      \node[anchor=east] at (3, 3.00) {10};
      \node[anchor=west] at (3.25, 3.00) {$\overline{CLR}$};
      \node[anchor=east] at (3, 2.25) {9};
      \node[anchor=west] at (3.25, 2.25) {Q7};
    \end{tikzpicture}
    \caption{\figureCaption}
    \label{fig:shift-register-piso}
  \end{figure}
}
