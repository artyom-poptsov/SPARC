...
\newcommand{\figureShiftRegisterPISO}[1]{
  ...
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}
      ...
      \node[anchor=east] at (-0.25, 6.00) {E};
      \node[anchor=west] at (0, 5.25) {4};
      \node[anchor=east] at (-0.25, 5.25) {F};
      \node[anchor=west] at (0, 4.50) {5};
      \node[anchor=east] at (-0.25, 4.50) {G};
      \node[anchor=west] at (0, 3.75) {6};
      \node[anchor=east] at (-0.25, 3.75) {H};
      \node[anchor=west] at (0, 3.00) {7};
      \node[anchor=east] at (-0.25, 3.00) {$\overline{Q}_H$};
      ...
      \node[anchor=west] at (3.25, 6.75) {CLK INH};
      \node[anchor=east] at (3, 6.00) {14};
      \node[anchor=west] at (3.25, 6.00) {D};
      \node[anchor=east] at (3, 5.25) {13};
      \node[anchor=west] at (3.25, 5.25) {C};
      \node[anchor=east] at (3, 4.50) {12};
      \node[anchor=west] at (3.25, 4.50) {B};
      \node[anchor=east] at (3, 3.75) {11};
      \node[anchor=west] at (3.25, 3.75) {A};
      \node[anchor=east] at (3, 3.00) {10};
      \node[anchor=west] at (3.25, 3.00) {SER};
      \node[anchor=east] at (3, 2.25) {9};
      \node[anchor=west] at (3.25, 2.25) {$Q_H$};
    \end{tikzpicture}
