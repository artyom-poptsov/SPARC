...
Объявим в файле ``music.ino'' ноты.
...
\mintinline{cpp}{LENGTH}, хранящую его длину.  В итоге, файл будет иметь
...
Начнём с того, что в файле ``music.ino'' мы объявим необходимые нам ноты.
