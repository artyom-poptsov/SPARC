...
\usepackage{imakeidx}
\usepackage{hyperref} % Must go after "imakeidx"
...
\makeindex
\makeindex[name=hardware,title=Аппаратное обеспечение]
\makeglossaries
...
\input{common/figureAVRMemory.tex}
\input{common/figureAnalogSignalExample.tex}
\input{common/figureArray.tex}
\input{common/figureArrayOfPointers.tex}
\input{common/figureBigLCD.tex}
\input{common/figureBigLCDSchematics.tex}
\input{common/figureBlinkinLEDGraph.tex}
\input{common/figureBuildIndirectInclusion.tex}
\input{common/figureBuildSteps.tex}
\input{common/figureBuildStepsHeaders.tex}
\input{common/figureBuildStepsMultipleFiles.tex}
\input{common/figureButtonBounceGraph.tex}
\input{common/figureButtonCircuit.tex}
\input{common/figureButtonPulldownResistorCircuit.tex}
\input{common/figureButtonPullupResistorCircuit.tex}
\input{common/figureDigitalSignalExample.tex}
\input{common/figureElectronicsConnectedWaterVessels.tex}
\input{common/figureElectronicsLED.tex}
\input{common/figureElectronicsLEDCircuit.tex}
\input{common/figureElectronicsResistance.tex}
\input{common/figureElectronicsResistorCircuit.tex}
\input{common/figureElectronicsSequentialResistors.tex}
\input{common/figureElectronicsSimpleCircruit.tex}
\input{common/figureElectronicsVoltage.tex}
\input{common/figureElectronicsVoltageWithCurrent.tex}
\input{common/figureElectronicsWaterVessels.tex}
\input{common/figureIICSchematics.tex}
\input{common/figureInterruptTimerCompare.tex}
\input{common/figureInterruptTimerOverflow.tex}
\input{common/figureInterruptTypes.tex}
\input{common/figureLCDChar.tex}
\input{common/figureLCDCharAnimation.tex}
\input{common/figureLCDCharPlayer.tex}
\input{common/figureLCDCharRow.tex}
\input{common/figureLCDConnection.tex}
\input{common/figureLCMLeds.tex}
\input{common/figureMemoryHierarchy.tex}
\input{common/figureMusicBarFourFour.tex}
\input{common/figureMusicBarFourFourWithFrequencies.tex}
\input{common/figureMusicSixBars.tex}
\input{common/figureMusicSixBarsFourFour.tex}
\input{common/figureMusicTripletExample.tex}
\input{common/figureMusicTwinkleTwinkleLittleStar.tex}
\input{common/figureMusicWeWillRockYouSimplified.tex}
\input{common/figureProtocolClassification.tex}
\input{common/figureSPI.tex}
\input{common/figureSPIShiftRegister.tex}
\input{common/figureSPIShiftRegisterConnections.tex}
\input{common/figurePWMGraph.tex}
\input{common/figureSerialPortDiagram.tex}
\input{common/figureShiftRegisterSIPO.tex}
\input{common/figureShiftRegisterSIPODiagram.tex}
\input{common/figureShiftRegisterPISO.tex}
\input{common/figureShiftRegisterUniversal.tex}
\input{common/figureSmallLCD.tex}
\input{common/figureSmallLCDSchematics.tex}
\input{common/figureSoundGraph.tex}
\input{common/figureVoltageDivider.tex}
\input{common/figureVoltageDividerPotentiometer.tex}
\input{common/tableBitwiseAND.tex}
\input{common/tableBitwiseNOT.tex}
\input{common/tableBitwiseOR.tex}
\input{common/tableBitwiseXOR.tex}
\input{common/tableCommunicationSerialPorts.tex}
\input{common/tableGPWR.tex}
\input{common/tableMusicNoteLengths.tex}
\input{common/tableMusicOctaveExample.tex}
\input{common/tableMusicTwinkleTwinkleLittleStar.tex}
\input{common/tableMusicTwinkleTwinkleLittleStarNotes.tex}
\input{common/tableIICPorts.tex}
\input{common/tableIVT.tex}
\input{common/tableInterrupts.tex}
\input{common/tableLCM.tex}
\input{common/tableMCUPortsExample.tex}
\input{common/tableSPIPorts.tex}
\input{common/tableTCCR.tex}
\input{common/tableTCCRbits.tex}
...
\subfile{sections/dialogues-with-computer-procedures}
...
\subfile{sections/white-noise-voltage-divider}
...
\subfile{sections/communication-bitwise-operations}
\subfile{sections/communication-shift-registers}
\subfile{sections/communication-spi}
...
\subfile{sections/game-dev-engine}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Путешествие к центру микроконтроллера}
\subfile{sections/mcu-intro}
\subfile{sections/mcu-interrupts-types}
\subfile{sections/mcu-interrupts-hw-external}
\subfile{sections/mcu-memory}
\subfile{sections/mcu-port-manipulation}
\subfile{sections/mcu-interrupts-hw-internal}
\subfile{sections/mcu-interrupts-music}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\addcontentsline{toc}{chapter}{Аппаратное обеспечение}
\printindex[hardware]
...
\subfile{sections/appendix-daisy-bell-score}
