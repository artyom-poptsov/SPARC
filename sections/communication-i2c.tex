...
битов мы сможем управлять состоянием светодиодов.
...
Таким образом мы включили один светодиод, подключенный к модулю PCF8574.
...
В пример кода \ref{listing:communication-pcf8574} реализовано мигание одним из
